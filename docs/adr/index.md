...
| [0038](./0038-generative-ui-artifacts-two-mode.md) | Generative-UI artifacts (sandboxed iframe, à la Claude/Open WebUI) + two-mode plugin UI (iframe-sandbox for untrusted, build-time `src/ext` registry for forks); **retires Module Federation** | Proposed |
