...
FIELDS: list[Field] = [
    ...
    Field(
        ...
        "bundled Docker compose — a desktop-launched agent needs a real URL here, or a "
        "LANGFUSE_HOST in the environment, which blank falls back to first. Applies to the key "
        "pair below; credentials from LANGFUSE_PUBLIC_KEY / LANGFUSE_SECRET_KEY use "
        "LANGFUSE_HOST instead and never this (#3039).",
        restart=True,
    ...
    Field(
        ...
        "number",
        "Runtime",
        "Warn when this process's resident memory crosses this (0 = off). There is no "
    ...
    Field(
        ...
        "memory_ceiling_exit",
        "Exit when the memory ceiling is crossed",
        "bool",
        "Runtime",
        "Off by default: crossing the ceiling only warns. Turn this on when something "
