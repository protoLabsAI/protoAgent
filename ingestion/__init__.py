...
Markdown, HTML / web URLs, PDF, Word (.docx — python-docx, a core dep; only a broken
install lacks it, and that answers with a ``MissingDependency``), and YouTube transcripts.
