...
# own cap — otherwise pinning is just unbounded growth. 0 refuses every NEW pin; existing pins
# stay protected until unpinned (lowering the cap never unpins anything).
def _max_pinned() -> int:
