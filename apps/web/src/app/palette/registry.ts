...
// `navigate` is handed in rather than imported by that module so it has no runtime edge back
// to this one — and so a test can assert the exact intent a row emits.
