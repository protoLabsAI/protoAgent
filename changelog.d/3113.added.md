- **protoAgent owns its ChatGPT login, and one console sign-in serves every instance (#3113, ADR 0097).**
  Two problems with one cause. A refresh token is single-use, but protoAgent read the Codex CLI's
