- **A message typed into a background, scheduled or watch-triggered turn now lands in the chat instead of sitting "queued" forever (#3446).**
  ...
  rather than silently riding a later turn; one the server refused, or that nothing can account
  for, comes back into the composer instead of vanishing; and Stop no longer discards what it
  clears. A transient failure while working this out is retried rather than leaving a bubble
