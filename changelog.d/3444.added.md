- **Word `.docx` files attach in chat and ingest into Knowledge; the desktop runtime can read PDFs again (#3444).**
  ...
  parts itself in bounded steps and refuses (413) anything past ~12 MB of XML or ~1M
  elements — a hostile kilobyte-sized file can no longer drive gigabytes of memory.
