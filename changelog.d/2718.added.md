- **Bundles now have a lifecycle past install — update, re-pin, and uninstall as one
  action (#2718, ADR 0049 D4) — and a real guide.** A bundle was first-class at install
